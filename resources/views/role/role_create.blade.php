                  ...
                  <div class="card mb-6">
                    ...
                    <div class="dt-action-buttons text-end">
                            <div class="dt-buttons btn-group flex-wrap">
                                <div class="btn-group">
                                                  <a href="{{url('role/list')}}" class="btn btn-secondary create-new btn-primary text-white" style="margin-right: 27px;" tabindex="0" aria-controls="DataTables_Table_0" type="button"><span> <span class="d-none d-sm-inline-block">Role List</span></span></a>
                            </div>
                        </div>
                    </div>
                    <div class="card-body">
